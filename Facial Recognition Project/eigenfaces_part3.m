...
%%%, 'individu_moyenM', 'ligne_max','ligne_min', 'colonne_max', 'colonne_min', 'X_centreM', 'VectM'
...
save('eigenfaces_part3.mat', 'individu_moyen', 'lambda', 'W', 'X_centre', 'nb_personnes', 'nb_postures', 'nb_personnes_base', 'nb_postures_base', ...
    'liste_personnes_base', 'liste_personnes', 'liste_postures', 'L', 'H', 'ligne_max','ligne_min', 'colonne_max', 'colonne_min')
